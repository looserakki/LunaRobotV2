...
if ENV:
    ...
    BOT_ID = int(os.environ.get("BOT_ID", "5046520072"))
    ...
    BAN_STICKER = os.environ.get("BAN_STICKER", "CAACAgUAAxkBAAIOaWHTt4Ba5-ujIwABbmFrpJb30_0gKAAC_AIAArYHcFa88Ua1bTlY2CME")
